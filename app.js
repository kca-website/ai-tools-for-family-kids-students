...
(function () {
  ...
  const STRINGS = {
    el: {
      ...
      homeVideoNewBadge: "Νέο",
      homeVideoNewTitle: "Δημιουργία εκπαιδευτικών βίντεο",
      homeVideoNewText: "Από πραγματική ύλη ή δικό σου κείμενο/PDF, με ελληνική αφήγηση, υπότιτλους και επεξεργασία σκηνών.",
      homeVideoNewCta: "Δοκίμασέ το →",
    ...
    en: {
      ...
      homeVideoNewBadge: "New",
      homeVideoNewTitle: "Create educational videos",
      homeVideoNewText: "Turn mapped curriculum or your own text/PDF into a video with Greek narration, captions and scene editing.",
      homeVideoNewCta: "Try it →",
