...
(function () {
  ...
  const STRINGS = {
    el: {
      ...
      homeAssessmentEyebrow: "Για εκπαιδευτικούς",
      homeAssessmentTitle: "Δωρεάν φύλλο αξιολόγησης με AI",
      homeAssessmentText: "Διάλεξε βαθμίδα, τάξη, μάθημα και ενότητα. Δημιούργησε διαγνωστικό, επαναληπτικό, τελικό φύλλο ή ρουμπρίκα, με ξεχωριστό κλειδί απαντήσεων.",
      homeAssessmentNote: "Όπου υπάρχει επαληθευμένη χαρτογράφηση 2026–27 χρησιμοποιείται αυτή· διαφορετικά ζητείται ο ακριβής τίτλος και δεν επινοείται ύλη.",
      homeAssessmentCta: "Δημιούργησε φύλλο αξιολόγησης →",
      homeAssessmentLearn: "Πώς λειτουργεί",
    ...
    en: {
      ...
      homeAssessmentEyebrow: "For educators",
      homeAssessmentTitle: "Free AI assessment-sheet builder",
      homeAssessmentText: "Choose school level, grade, subject and topic. Create a diagnostic, review, final assessment or rubric with a separate answer key.",
      homeAssessmentNote: "Verified 2026–27 mapping is used where available; otherwise the teacher is asked for the exact topic instead of inventing curriculum.",
      homeAssessmentCta: "Create an assessment sheet →",
      homeAssessmentLearn: "How it works",
