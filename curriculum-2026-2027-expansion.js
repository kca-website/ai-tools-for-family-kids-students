  ...
  function verifiedSubject({ id, grade, labelEl, labelEn, rows, sourceLabelEl }) {
    ...
    return {
      ...
      curriculum: {
        ...
        coverageLabelEl: "Αναλυτικός χάρτης βάσει επίσημων οδηγιών 2026–27",
        coverageLabelEn: "Detailed map based on official 2026–27 guidance",
        officialSectionsEl: [],
        officialSectionsEn: [],
        scopeNoteEl: "Οι επιλογές είναι θεματικός χάρτης που αποδίδει το περιεχόμενο των επίσημων οδηγιών 2026–27 για πλοήγηση και εξάσκηση. Δεν παρουσιάζονται ως αυτούσιοι επίσημοι τίτλοι ενοτήτων ούτε ως πλήρης εξεταστέα ύλη. Όπου υπάρχει προαιρετικό υλικό, αυτό δηλώνεται.",
        scopeNoteEn: "These choices are a navigation map derived from the official 2026–27 guidance. They are not presented as verbatim official unit titles or a complete examinable syllabus. Optional material is identified where applicable.",
