...
const CURRICULUM = {
  ...
  high: {
    language: {toolIds: ["ai-help", "gemini-education", "copilot", "chatgpt", "notebooklm", "quizlet", "perplexity", "anki", "notion"],noteEl: "Ανάπτυξη και έλεγχος επιχειρημάτων για έκθεση, προετοιμασία Πανελληνίων.",noteEn: "Developing and stress-testing essay arguments, Panhellenic exam prep."},
    ...
    science: {toolIds: ["phet", "ai-help", "wolfram-alpha", "chatgpt-edu", "gemini-education", "copilot", "chatgpt", "notebooklm", "quizlet", "perplexity", "google-lens"],noteEl: "Υπολογισμοί Φυσικής/Χημείας και υποστήριξη μέσω σχολικού προγράμματος.",noteEn: "Physics/Chemistry calculations and support via the school pilot program."},
    history: {toolIds: ["google-arts-culture", "ai-help", "perplexity", "gemini-education", "copilot", "chatgpt", "notebooklm", "quizlet", "zotero", "gamma", "notion", "google-lens"],noteEl: "Οργάνωση επιχειρημάτων και έλεγχος ιστορικών γεγονότων με πηγές πριν τα εμπιστευτείς.",noteEn: "Organizing arguments and checking historical facts against sources before trusting them."},
