...
const NEED_TOOL_MAP = {
  language: {
    ...
    check: ["chatgpt", "grammarly", "notebooklm"],
    revise: ["notebooklm", "quizlet", "anki", "notion", "digital-tutoring", "chatgpt", "gemini-education"],
    research: ["perplexity", "notebooklm", "chatgpt", "zotero"],
  },
  math: {
    ...
    revise: ["quizlet", "anki", "digital-tutoring", "chatgpt"],
  ...
  science: {
    ...
    hint: ["ai-help", "chatgpt"],
    check: ["wolfram-alpha", "chatgpt", "notebooklm", "digital-tutoring"],
    revise: ["notebooklm", "quizlet", "anki", "digital-tutoring", "chatgpt"],
    research: ["perplexity", "notebooklm", "google-lens", "scite"],
  },
  history: {
    understand: ["google-arts-culture", "ai-help", "chatgpt", "gemini-education", "notebooklm"],
    practice: ["ai-help", "chatgpt", "quizlet", "anki", "digital-tutoring"],
    hint: ["ai-help", "chatgpt"],
    check: ["perplexity", "chatgpt", "notebooklm"],
    revise: ["notebooklm", "quizlet", "anki", "notion", "digital-tutoring", "chatgpt"],
  ...
  "foreign-language": {
    ...
    check: ["grammarly", "chatgpt", "deepl"],
    revise: ["quizlet", "anki", "notebooklm", "deepl"],
    research: ["perplexity", "chatgpt", "deepl"],
  },
};
