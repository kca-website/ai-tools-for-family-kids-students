...
const CURRICULUM = {
  ...
  middle: {
    language: {toolIds: ["ai-help", "gemini-education", "copilot", "chatgpt"],noteEl: "Ανάπτυξη επιχειρημάτων για έκθεση, εξάσκηση στην ελληνική γλώσσα.",noteEn: "Developing essay arguments, Greek language practice."},
  ...
  high: {
    ...
    math: {toolIds: ["ai-help", "wolfram-alpha", "gemini-education", "copilot", "chatgpt"],noteEl: "Επαλήθευση σύνθετων προβλημάτων Μαθηματικών Προσανατολισμού.",noteEn: "Verification of complex advanced-track math problems."},
    science: {toolIds: ["phet", "ai-help", "wolfram-alpha", "chatgpt-edu", "gemini-education", "copilot", "chatgpt"],noteEl: "Υπολογισμοί Φυσικής/Χημείας και υποστήριξη μέσω σχολικού προγράμματος.",noteEn: "Physics/Chemistry calculations and support via the school pilot program."},
    history: {toolIds: ["google-arts-culture", "ai-help", "perplexity", "gemini-education", "copilot", "chatgpt"],noteEl: "Οργάνωση επιχειρημάτων και έλεγχος ιστορικών γεγονότων με πηγές πριν τα εμπιστευτείς.",noteEn: "Organizing arguments and checking historical facts against sources before trusting them."},
