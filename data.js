...
const TOOLS = {
  ...
  "deepl": {
    ...
    logo: null,
    minAge: 14,
    minAgeNote: "Η πολιτική απορρήτου αναφέρει ότι η υπηρεσία δεν προορίζεται για παιδιά κάτω των 14. Η δωρεάν υπηρεσία δεν απαιτεί συνδρομή· σε δωρεάν χρήση, το περιεχόμενο που υποβάλλεται μπορεί να υποβληθεί σε περιορισμένη επεξεργασία για βελτίωση των μοντέλων.",
  ...
  "google-lens": {
    ...
    category: "research",
    logo: null,
    shortDescEl: "Οπτική αναζήτηση από φωτογραφία ή κάμερα για αναγνώριση αντικειμένων, κειμένου, φυτών, τόπων και σχετικών πηγών.",
    shortDescEn: "Visual search from camera or images for identifying objects, text, plants, places, and related sources.",
    greekTips: "Χρήσιμο ως αφετηρία αναζήτησης, όχι ως τελική πηγή. Άνοιγε το αποτέλεσμα/ιστοσελίδα που προτείνει και έλεγχε την αξιοπιστία του.",
  },
  "gamma": {
    id: "gamma",
    name: "Gamma",
  ...
  middle: {
    guardian: {
      ...
      tools: [
        ...
        {
          toolId: "google-lens",
          useCaseEl: "Φυσικές Επιστήμες και οπτική έρευνα: αναγνώριση φυτών, αντικειμένων, κειμένου ή εικόνων και μετάβαση στις σχετικές πηγές.",
          useCaseEn: "Science and visual research: identify plants, objects, text or images and continue to relevant sources.",
    ...
    student: {
      ...
      tools: [
        ...
        {
          toolId: "google-lens",
          useCaseEl: "Για να αναγνωρίσεις κάτι που βλέπεις σε εικόνα/φωτογραφία και να βρεις σχετικές πηγές.",
          useCaseEn: "To identify something in an image/photo and find related sources.",
