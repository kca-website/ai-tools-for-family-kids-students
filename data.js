...
const TOOLS = {
  ...
  "gemini": {
    ...
    logo: null,
    minAge: 13,
    minAgeNote: "13 ετών και άνω για προσωπικό λογαριασμό. Διόρθωση: το Gemini μέσω Google Family Link για κάτω των 13 ΔΕΝ είναι διαθέσιμο στον Ευρωπαϊκό Οικονομικό Χώρο (άρα ούτε στην Ελλάδα), στο Ηνωμένο Βασίλειο ή στην Ελβετία: επιβεβαιωμένο απευθείας από τη Google (Gemini Apps Help, support.google.com/gemini/answer/16109150). Η μόνη διαθέσιμη διαδρομή για κάτω των 13 στην Ελλάδα είναι μέσω σχολικού λογαριασμού Google Classroom, αν το ενεργοποιήσει το σχολείο. Από 10/8/2026, το Gemini μέσα στο Google Classroom άνοιξε σε μαθητές όλων των ηλικιών (και Δημοτικού) μέσω σχολικού λογαριασμού: flashcards, quiz εξάσκησης και οδηγοί μελέτης βασισμένα στο δικό τους υλικό, χωρίς να εκπαιδεύεται το μοντέλο πάνω στα δεδομένα τους. Ανεξάρτητες αξιολογήσεις (Common Sense Media) σημειώνουν ότι το γενικό Gemini (εκτός Classroom) δεν διαφοροποιεί επαρκώς τις απαντήσεις του ανάμεσα σε 13χρονο και 17χρονο χρήστη: μεγαλύτερη ανάγκη γονικής επίβλεψης σε σχέση με εργαλεία σχεδιασμένα ειδικά για παιδιά.",
  ...
  "notebooklm": {
    ...
    isExpert: true,
    minAge: 13,
    minAgeNote: "13 ετών και άνω για προσωπικό λογαριασμό (Όροι Χρήσης Google). Μέσω σχολικού λογαριασμού Google Workspace for Education είναι διαθέσιμο σε μαθητές όλων των ηλικιών, αν το ενεργοποιήσει το σχολείο. Παλαιότερα λεγόταν 'NotebookLM': η παλιά διεύθυνση notebooklm.google.com ανακατευθύνει ακόμα στη νέα.",
  ...
  middle: {
    guardian: {
      ...
      tools: [
        ...
        {
          toolId: "copilot",
          useCaseEl: "Βοήθεια σε εργασίες μέσα από Word/PowerPoint αν το σχολείο έχει λογαριασμό Microsoft 365.",
          useCaseEn: "Help with assignments directly inside Word/PowerPoint if the school has a Microsoft 365 account.",
          howToEl: "Διαθέσιμο χωρίς επιπλέον χρέωση μόνο μέσω σχολικού Microsoft 365 λογαριασμού, εφόσον το ενεργοποιήσει το σχολείο. Προσωπικός λογαριασμός δεν έχει πρόσβαση κάτω των 13.",
          howToEn: "Free through a school Microsoft 365 account only, if the school enables it. A personal account has no access under 13.",
          cautionEl: "",
          cautionEn: "",
        },
        {
    ...
    student: {
      ...
      tools: [
        ...
        {
          toolId: "copilot",
          useCaseEl: "Για να πάρεις βοήθεια μέσα στο ίδιο το Word ή το PowerPoint όταν γράφεις μια εργασία.",
          useCaseEn: "To get help right inside Word or PowerPoint while writing an assignment.",
          howToEl: "Χρησιμοποιείται μόνο μέσω του σχολικού λογαριασμού, αν το σχολείο σου το έχει ενεργοποιήσει.",
          howToEn: "Only used through your school account, if your school has enabled it.",
          cautionEl: "",
          cautionEn: "",
        },
        {
  ...
  high: {
    guardian: {
      ...
      tools: [
        ...
        {
          toolId: "copilot",
          useCaseEl: "Βοήθεια σε εργασίες μέσα από Word/PowerPoint/Excel αν το σχολείο έχει λογαριασμό Microsoft 365.",
          useCaseEn: "Help with assignments directly inside Word/PowerPoint/Excel if the school has a Microsoft 365 account.",
          howToEl: "Διαθέσιμο χωρίς επιπλέον χρέωση μόνο μέσω σχολικού Microsoft 365 λογαριασμού, εφόσον το ενεργοποιήσει το σχολείο.",
          howToEn: "Free through a school Microsoft 365 account only, if the school enables it.",
          cautionEl: "",
          cautionEn: "",
        },
        {
    ...
    student: {
      ...
      tools: [
        ...
        {
          toolId: "copilot",
          useCaseEl: "Για να πάρεις βοήθεια μέσα στο ίδιο το Word, PowerPoint ή Excel όταν ετοιμάζεις μια εργασία.",
          useCaseEn: "To get help right inside Word, PowerPoint, or Excel while preparing an assignment.",
          howToEl: "Χρησιμοποιείται μόνο μέσω του σχολικού λογαριασμού Microsoft 365, αν το σχολείο σου το έχει ενεργοποιήσει.",
          howToEn: "Only used through your school's Microsoft 365 account, if your school has enabled it.",
          cautionEl: "",
          cautionEn: "",
        },
        {
