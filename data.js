...
const TOOLS = {
  ...
  "gemini": {
    ...
    logo: null,
    minAge: 15,
    minAgeNote: "Για προσωπικό Google Account στην Ελλάδα ισχύει το όριο διαχείρισης λογαριασμού 15+. Οι εποπτευόμενοι Family Link λογαριασμοί μικρότερων ηλικιών δεν έχουν πρόσβαση στο Gemini στον ΕΟΧ. Ξεχωριστή σχολική διαδρομή μπορεί να υπάρχει μέσω Google Workspace for Education όταν το σχολείο την ενεργοποιεί.",
  ...
  "notebooklm": {
    ...
    isExpert: true,
    minAge: 15,
    minAgeNote: "Για προσωπικό Google Account στην Ελλάδα ισχύει όριο 15+. Με Google Workspace for Education μπορεί να ισχύει διαφορετική, διαχειριζόμενη πρόσβαση από το ίδρυμα. Το NotebookLM μετονομάστηκε επίσημα σε Gemini Notebook στις 16/7/2026.",
