...
const TOOLS = {
  ...
  "chatgpt": {
    ...
    logo: null,
    minAge: 13,
    minAgeNote: "13 ετών και άνω. Από 18/8/2026, οι χρήστες 13-17 ετών μεταφέρονται αυτόματα στο ChatGPT for Teens — ειδική, πιο ασφαλής εμπειρία με αυστηρότερους περιορισμούς περιεχομένου, 'Study Mode' (εξηγήσεις βήμα-βήμα αντί για έτοιμες απαντήσεις) και εντοπισμό προσπαθειών παράκαμψης εργασιών. Ενεργοποιείται όταν ο χρήστης δηλώσει ηλικία 13-17, ή αν το σύστημα το εκτιμήσει.",
