...
const TOOLS = {
  ...
  "notebooklm": {
    ...
    shortDescEl: "AI εργαλείο έρευνας που απαντά ΜΟΝΟ βάσει των πηγών που του ανεβάζεις εσύ, με παραπομπή στο ακριβές απόσπασμα.",
    shortDescEn: "AI research tool that answers ONLY from the sources you upload, citing the exact passage.",
    greekTips: "Ανέβασε το επίσημο ψηφιακό σχολικό βιβλίο από το ebooks.edu.gr (π.χ. Ιστορία ή Φυσικά της τάξης του παιδιού) ως τη μοναδική πηγή του notebook. Το εργαλείο τότε απαντά αποκλειστικά από αυτό το βιβλίο και δείχνει ακριβώς από πού πήρε κάθε απάντηση: πολύ πιο ασφαλές από γενικό chatbot για μικρή ηλικία, γιατί δεν μπορεί να 'επινοήσει' κάτι έξω από το βιβλίο. Ιδανικό ακριβώς επειδή περιορίζεται μόνο στην ύλη, όχι επειδή είναι αλάνθαστο.",
  },
  "perplexity": {
    id: "perplexity",
    name: "Perplexity",
    ...
    student: {
      ...
      tools: [
        ...
        },
        {
          ...
          howToEl: "Ανέβασε μόνο τις δικές σου σημειώσεις ή επιτρεπόμενες πηγές. Για προσωπικό Google Account στην Ελλάδα ισχύει όριο 15+, ενώ σε Google Workspace for Education η πρόσβαση διαχειρίζεται από το ίδρυμα.",
          howToEn: "Upload only your own notes or permitted sources. For a personal Google Account in Greece, the account-management age is 15+; Google Workspace for Education access is managed by the institution.",
