  ...
  middle: {
    ...
    student: {
      ...
      tools: [
        ...
        {
          toolId: "quizlet",
          useCaseEl: "Για να φτιάξεις flashcards και να κάνεις επανάληψη πριν το διαγώνισμα.",
          useCaseEn: "To make flashcards and review before a test.",
          howToEl: "Γράψε τους δικούς σου όρους και ορισμούς σε flashcards: έτσι θυμάσαι καλύτερα απ' όσο αν τα έφτιαχνε το AI για σένα.",
          howToEn: "Write your own terms and definitions as flashcards: you remember better this way than if AI made them for you.",
          cautionEl: "Οι πιο προχωρημένες λειτουργίες (Magic Notes, Q-Chat) χρειάζονται συνδρομή. Η δωρεάν έκδοση αρκεί για βασικά flashcards.",
          cautionEn: "The more advanced features (Magic Notes, Q-Chat) require a subscription. The free version is enough for basic flashcards.",
        },
        {
          toolId: "gemini-education",
          useCaseEl: "Μόνο αν σου το έχει δώσει το σχολείο: σχολική πρόσβαση στο Gemini μέσα από Google Workspace for Education.",
  ...
  high: {
    ...
    student: {
      ...
      tools: [
        ...
        {
          toolId: "quizlet",
          useCaseEl: "Επανάληψη πριν τις Πανελλήνιες ή τα διαγωνίσματα, με flashcards και practice tests.",
          useCaseEn: "Review before Panhellenic exams or tests, with flashcards and practice tests.",
          howToEl: "Φτιάξε τα δικά σου flashcards ανά μάθημα ώστε να επεξεργάζεσαι εσύ το υλικό, όχι απλά να το διαβάζεις έτοιμο.",
          howToEn: "Make your own subject-by-subject flashcards so you're processing the material yourself, not just reading it ready-made.",
          cautionEl: "Οι πιο προχωρημένες AI λειτουργίες (Magic Notes, Q-Chat) χρειάζονται συνδρομή Plus.",
          cautionEn: "The more advanced AI features (Magic Notes, Q-Chat) require a Plus subscription.",
        },
        {
