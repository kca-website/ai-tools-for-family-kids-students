...
const TOOLS = {
  ...
  "notebooklm": {
    ...
    logo: null,
    minAge: 18,
    minAgeNote: "Απαιτεί προσωπικό λογαριασμό Google 18 ετών και άνω, ή σχολικό λογαριασμό Google Workspace for Education. Σημείωση: μέρος αυτής της λειτουργίας εμφανίζεται πλέον και ως 'Gemini Notebook' μέσα στην εφαρμογή Gemini (από 6/2026) — χρειάζεται επιβεβαίωση αν το notebooklm.google.com παραμένει ενεργό ξεχωριστά.",
