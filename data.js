...
const TOOLS = {
  ...
  "chatgpt-edu": {
    ...
    logo: null,
    minAge: 12,
    minAgeNote: "Πιλοτικό πρόγραμμα σε ελληνικά σχολεία από το 2026. Μέσω σχολικού λογαριασμού. Προσοχή: από 18/8/2026 το OpenAI κυκλοφόρησε παγκοσμίως το ChatGPT for Teens (13-17, αυτόματη αναγνώριση ηλικίας), διαφορετικό προϊόν από το σχολικό πιλοτικό. Το entry χρειάζεται επανεξέταση.",
