...
(function(){
  ...
  const COPY = {
    el: {
      ...
      educatorNote: "Για εκπαιδευτικούς: Δημοτικό, Γυμνάσιο, ΓΕΛ, ΕΠΑΛ και ειδική εκπαίδευση με πηγές 2026–27",
    ...
    en: {
      ...
      educatorNote: "For educators: Primary, Middle School, General Lyceum, EPAL and special education with 2026–27 sources",
