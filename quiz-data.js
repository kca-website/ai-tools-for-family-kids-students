...
const GAP_TAGS = {
  ...
  "math-a-dim.number-order": {
    ...
    recommendedToolIds: ["khanmigo", "photomath", "khan-academy-kids"],
  ...
  "math-a-dim.shape-recognition": {
    ...
    recommendedToolIds: ["khanmigo", "geogebra", "khan-academy-kids"],
  ...
  "glossa-a-dim.letter-sound-confusion": {
    ...
    recommendedToolIds: ["khanmigo", "khan-academy-kids"],
  ...
  "glossa-c-dim.description-paragraph": {
    ...
    recommendedToolIds: ["khanmigo", "mindmup"],
  ...
  "math-d-dim.perimeter-concept": {
    ...
    recommendedToolIds: ["khanmigo", "geogebra"],
