...
(function () {
  ...
  const envQuizzes = {
    "environment-a-dimotikou": { id:"environment-a-dimotikou", grades:["a"], subjectLabelEl:"Μελέτη Περιβάλλοντος, Α' Δημοτικού", subjectLabelEn:"Environment Studies, 1st Grade", titleEl:"Ο Χάρτης Εξάσκησης Μάθησης", titleEn:"The Practice Map", introEl:"5 σύντομες ερωτήσεις. Δεν είναι διαγώνισμα, δεν έχει βαθμό.", introEn:"5 short questions. It's not a graded test.", questions:[
    ...
    "environment-b-dimotikou": { id:"environment-b-dimotikou", grades:["b"], subjectLabelEl:"Μελέτη Περιβάλλοντος, Β' Δημοτικού", subjectLabelEn:"Environment Studies, 2nd Grade", titleEl:"Ο Χάρτης Εξάσκησης Μάθησης", titleEn:"The Practice Map", introEl:"5 σύντομες ερωτήσεις. Δεν είναι διαγώνισμα, δεν έχει βαθμό.", introEn:"5 short questions. It's not a graded test.", questions:[
    ...
    "environment-c-dimotikou": { id:"environment-c-dimotikou", grades:["c"], subjectLabelEl:"Μελέτη Περιβάλλοντος, Γ' Δημοτικού", subjectLabelEn:"Environment Studies, 3rd Grade", titleEl:"Ο Χάρτης Εξάσκησης Μάθησης", titleEn:"The Practice Map", introEl:"5 σύντομες ερωτήσεις. Δεν είναι διαγώνισμα, δεν έχει βαθμό.", introEn:"5 short questions. It's not a graded test.", questions:[
    ...
    "environment-d-dimotikou": { id:"environment-d-dimotikou", grades:["d"], subjectLabelEl:"Μελέτη Περιβάλλοντος, Δ' Δημοτικού", subjectLabelEn:"Environment Studies, 4th Grade", titleEl:"Ο Χάρτης Εξάσκησης Μάθησης", titleEn:"The Practice Map", introEl:"5 σύντομες ερωτήσεις. Δεν είναι διαγώνισμα, δεν έχει βαθμό.", introEn:"5 short questions. It's not a graded test.", questions:[
