window.SPECIAL_EDUCATION_STATUS = {
  ...
  rows: [
    ...
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αρχές Οικονομίας / Τομέας Διοίκησης & Οικονομίας",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αρχές Γραμμικού & Αρχιτεκτονικού Σχεδίου / Τομέας Δομικών",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αγωγή Υγείας / Τομέας Υγείας-Πρόνοιας-Ευεξίας",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Βασικές Αρχές Σύνθεσης / Εφαρμοσμένες Τέχνες",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Ερευνητική Εργασία στην Τεχνολογία",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αρχές Μηχανολογίας / Τομέας Μηχανολογίας",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Γεωπονία και Αειφόρος Ανάπτυξη / Τομέας Γεωπονίας",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    ...
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Β΄-Δ΄ · Τομέας Εφαρμοσμένων Τεχνών — υπόλοιπα subject-only μαθήματα",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Β΄-Δ΄ · Τομέας Μηχανολογίας — υπόλοιπα subject-only μαθήματα",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Β΄–Δ΄ · Τομέας Πληροφορικής — 24 verified μαθήματα με διαδρομή μελέτης",curriculum:"verified",learning:"verified",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Γ΄–Δ΄ · Πληροφορική — 14 πολυενότητες χαρτογραφήσεις με μικρό τεστ",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄–Δ΄ Λυκείου · 14 ακριβείς χαρτογραφήσεις βασικών μαθημάτων (Μαθηματικά, Φυσική, Χημεία, Νέα Ελληνικά, Αγγλικά)",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Β΄-Δ΄ · Τομέας Γεωπονίας, Τροφίμων και Περιβάλλοντος — υπόλοιπα subject-only μαθήματα",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    ...
    {school:"Ειδικό Γυμνάσιο",scope:"Α΄ · Οικιακή Οικονομία — επίσημο πλαίσιο κεφαλαίων",curriculum:"verified",learning:"verified",quiz:"pending",tutorContext:"verified"},
    {school:"Ειδικό Γυμνάσιο",scope:"Α΄–Γ΄ · Εργαστήρια Δεξιοτήτων — επίσημο θεματικό πλαίσιο",curriculum:"verified",learning:"verified",quiz:"pending",tutorContext:"verified"},
    {school:"Ειδικό Λύκειο",scope:"Πληροφορική, Λατινικά, Βιολογία — 8 ακριβείς section-level χαρτογραφήσεις 2026–27",curriculum:"verified",learning:"verified",quiz:"verified",tutorContext:"verified"},
    {school:"Ειδικό Λύκειο",scope:"Ιστορία και Νεοελληνική Γλώσσα — επίσημα πλαίσια δεξιοτήτων/μεθοδολογίας 2026–27",curriculum:"verified",learning:"verified",quiz:"pending",tutorContext:"verified"}
  ]
};
...
(function(){
  ...
  const files=[
    ...
    "/teacher-curriculum-eneegyl-official-sectors-2026-2027.js",
