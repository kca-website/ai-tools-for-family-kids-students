window.SPECIAL_EDUCATION_STATUS = {
  ...
  rows: [
    ...
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αρχές Οικονομίας / Τομέας Διοίκησης & Οικονομίας",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    ...
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αγωγή Υγείας / Τομέας Υγείας-Πρόνοιας-Ευεξίας",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Βασικές Αρχές Σύνθεσης / Εφαρμοσμένες Τέχνες",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Ερευνητική Εργασία στην Τεχνολογία",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Αρχές Μηχανολογίας / Τομέας Μηχανολογίας",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
    {school:"ΕΝ.Ε.Ε.ΓΥ.-Λ.",scope:"Α΄ · Γεωπονία και Αειφόρος Ανάπτυξη / Τομέας Γεωπονίας",curriculum:"verified",learning:"pending",quiz:"pending",tutorContext:"verified"},
