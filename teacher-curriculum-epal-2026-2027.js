(function(){
  ...
  const ELECTROTECHNICS_B=[
    "Κεφάλαιο 1 — Βασικές γνώσεις και έννοιες",
    "Κεφάλαιο 2 — Το συνεχές ρεύμα"
  ];
  const ANALOG_DIGITAL_B=[
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 1: Εισαγωγή στην Ηλεκτρονική",
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 2: Ημιαγωγοί",
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 3: Κρυσταλλοδίοδοι",
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 4: Τρανζίστορ",
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 5: Στοιχεία ημιαγωγών τεσσάρων στρώσεων",
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 6: Στοιχεία οπτοηλεκτρονικής",
    "Αναλογικά Ηλεκτρονικά — Κεφάλαιο 8: Τελεστικοί ενισχυτές Ι",
    "Συλλογή, Μεταφορά και Έλεγχος Δεδομένων — Κεφάλαιο 2: Αισθητήρια",
    "Ψηφιακά Ηλεκτρονικά — Κεφάλαιο 1: Άλγεβρα Boole και λογικές πύλες",
    "Ψηφιακά Ηλεκτρονικά — Κεφάλαιο 2: Αριθμητικά συστήματα και κώδικες",
    "Ψηφιακά Ηλεκτρονικά — Κεφάλαιο 3: Ανάλυση και σχεδίαση συνδυαστικών κυκλωμάτων",
    "Ψηφιακά Ηλεκτρονικά — Κεφάλαιο 4: Πολυπλέκτες - Αποπολυπλέκτες",
    "Ψηφιακά Ηλεκτρονικά — Κεφάλαιο 5: Αποκωδικοποιητές - Κωδικοποιητές"
  ];
  const MANUFACTURING_B=[
    "Κεφάλαιο 1 — Μηχανουργείο",
    "Κεφάλαιο 2 — Μηχανουργικά υλικά",
    "Κεφάλαιο 3 — Μετρήσεις",
    "Κεφάλαιο 4 — Τεχνολογία εργαλείων χειρός",
    "Κεφάλαιο 6 — Κατεργασίες διαμόρφωσης εν ψυχρώ",
    "Κεφάλαιο 7 — Συνδέσεις",
    "Κεφάλαιο 8 — Συγκολλήσεις",
    "Κεφάλαιο 9 — Σωληνώσεις",
    "Κεφάλαιο 10 — Χύτευση",
    "Κεφάλαιο 12 — Τεχνολογία επιμεταλλώσεων",
    "Κεφάλαιο 13 — Εργαλειομηχανές",
    "Κεφάλαιο 16 — Αντλίες - Αεροσυμπιεστές"
  ];
  const NAVIGATION_WEATHER_B=[
    "Ναυτιλία — Κεφάλαιο 1: Βασικές γνώσεις - Βασικοί ορισμοί",
    "Ναυτιλία — Κεφάλαιο 2: Ναυτιλιακές εκδόσεις - Γεωδαισία",
    "Ναυτιλία — Κεφάλαιο 3: Ναυτική Σήμανση",
    "Ναυτιλία — Κεφάλαιο 4: Ναυτικά Όργανα",
    "Ναυτιλία — Κεφάλαιο 5: Αναμέτρηση",
    "Ναυτιλία — Κεφάλαιο 6: Ακτοπλοΐα",
    "Ναυτική Μετεωρολογία — Ατμοσφαιρική Πίεση",
    "Ναυτική Μετεωρολογία — Άνεμος και Γενική Κυκλοφορία της Ατμόσφαιρας"
  ];
  const SHIP_ELECTRICAL_B=[
    "Κεφάλαιο 1 — Βασικές έννοιες του ηλεκτρισμού",
    "Κεφάλαιο 2 — Ο νόμος του Ωμ - Συνδεσμολογίες αντιστάσεων",
    "Κεφάλαιο 3 — Ηλεκτρική ενέργεια και ισχύς",
    "Κεφάλαιο 5 — Ηλεκτρομαγνητισμός",
    "Κεφάλαιο 6 — Ηλεκτρικές εγκαταστάσεις",
    "Κεφάλαιο 7 — Κίνδυνοι από το ηλεκτρικό ρεύμα",
    "Κεφάλαιο 8 — Ηλεκτρικές μηχανές"
  ];
  const MARINE_ENGINEERING_B=[
    "Ναυτικοί Ατμολέβητες — Κεφάλαιο 1: Εισαγωγικές γνώσεις",
    "Ναυτικοί Ατμολέβητες — Κεφάλαιο 2: Κατάταξη ναυτικών ατμολεβήτων",
    "Ναυτικοί Ατμολέβητες — Κεφάλαιο 5: Σύγκριση φλογαυλωτών και υδραυλωτών λεβήτων",
    "Ατμομηχανές — Κεφάλαιο 10: Εισαγωγικές γνώσεις ατμοστροβίλων",
    "Ατμομηχανές — Κεφάλαιο 20: Περιγραφή των μερών των ατμοστροβίλων",
    "Ατμομηχανές — Κεφάλαιο 30: Διάταξη εγκατάστασης ατμοστροβίλων στα εμπορικά πλοία",
    "Μηχανές Εσωτερικής Καύσεως — Κεφάλαιο 1: Εισαγωγή - Βασικές Έννοιες"
  ];
  ...
  const B_SECTOR_SUBJECTS=[
    ...
    sectorSubject("Ηλεκτρολογίας, Ηλεκτρονικής και Αυτοματισμού","electrotechnics","Ηλεκτροτεχνία (Κυκλώματα Συνεχούς και Εναλλασσόμενου Ρεύματος)",ELECTROTECHNICS_B,ELEC_2026),
    ...
    sectorSubject("Ηλεκτρολογίας, Ηλεκτρονικής και Αυτοματισμού","analog-digital-electronics","Αναλογικά και Ψηφιακά Ηλεκτρονικά",ANALOG_DIGITAL_B,ELEC_2026),
    ...
    sectorSubject("Μηχανολογίας","manufacturing","Τεχνολογία Μηχανολογικών Κατασκευών-Εφαρμογές",MANUFACTURING_B,MECH_2026),
    ...
    sectorSubject("Ναυτιλιακών Επαγγελμάτων","navigation-weather","Ναυσιπλοΐα Ι – Ναυτική Μετεωρολογία",NAVIGATION_WEATHER_B,MARITIME_TIMETABLE),
    sectorSubject("Ναυτιλιακών Επαγγελμάτων","ship-electrical-1","Ηλεκτρολογικές Εγκαταστάσεις Πλοίου Ι",SHIP_ELECTRICAL_B,MARITIME_TIMETABLE),
    ...
    sectorSubject("Ναυτιλιακών Επαγγελμάτων","marine-engineering","Ναυτική Μηχανολογία – Εφαρμογές",MARINE_ENGINEERING_B,MARITIME_TIMETABLE),
