...
(function () {
  ...
  const T = {
    el: {
      ...
      cost: "Η δημιουργία κάνει 1 κλήση AI στο Puter. Το γύρισμα, η πλοήγηση και το «Το ξέρω» μετά δεν κάνουν άλλες AI κλήσεις.",
      generate: "Φτιάξε 8 flashcards · 1 κλήση AI",
      openSaved: "Άνοιξε αποθηκευμένες κάρτες · 0 κλήσεις",
      regenerate: "Νέο σετ · 1 νέα κλήση AI",
      ...
      failed: "Δεν μπόρεσα να δημιουργήσω σωστό σετ καρτών. Δεν έγινε αυτόματη δεύτερη κλήση, ώστε να μη χρεωθεί επιπλέον χρήση.",
      question: "Ερώτηση",
      answer: "Απάντηση",
      ...
      cached: "Αυτό το σετ φορτώθηκε από τον browser χωρίς νέα κλήση AI.",
    },
    en: {
      title: "🃏 Practice flashcards",
      intro: "Create 8 short cards for the selected topic.",
      cost: "Generation makes 1 AI call to Puter. Flipping, navigation and self-rating afterwards make no more AI calls.",
      generate: "Create 8 flashcards · 1 AI call",
      openSaved: "Open saved cards · 0 calls",
      regenerate: "New set · 1 new AI call",
      ...
      failed: "I couldn't create a valid card set. No automatic second call was made, so no extra AI usage was consumed.",
      question: "Question",
      answer: "Answer",
      reveal: "Show answer",
      hide: "Hide answer",
      ...
      cached: "This set was loaded from the browser with no new AI call.",
    },
  };
